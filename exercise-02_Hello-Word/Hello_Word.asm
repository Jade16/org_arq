...
cores : var #13
static cores + #0, #1280 ; roxo
static cores + #1, #2048 ;cinza
static cores + #2, #768 ;oliva
static cores + #3, #512 ;verde
static cores + #4, #1024 ;azul marinho
static cores + #5, #256 ;marrom
static cores + #6, #1536 ;teal
static cores + #7, #2560 ;lima
static cores + #8, #3328 ;rosa
static cores + #9, #3584 ;aqua
static cores + #10, #2304 ;vermelho
static cores + #11, #0 ;branco
static cores + #12, #2816 ;amarelo
...
main:
	loadn r0, #500		; Posicao na tela onde a mensagem sera' escrita
